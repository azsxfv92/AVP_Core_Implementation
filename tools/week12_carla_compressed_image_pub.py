...
class CarlaImagePublisher(Node):
    def __init__(self):
        ...
        super().__init__("week12_carla_compressed_image_pub")
        ...
        self.pub_ = self.create_publisher(CompressedImage, "/avp/camera/front/compressed", camera_qos)

        self.output_dir = Path("results/week12/carla_compressed_image_pub")
    ...
    def on_image(self, image):
        ...
        if (self.received_count % 30) == 0:
            ...
            self.get_logger().info(
                ...
                f"published_count={self.received_count}"
            )
